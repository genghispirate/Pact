...
<p align="center"><em>Ready-to-install APK: <a href="release/Pact-v5.9.apk"><code>release/Pact-v5.9.apk</code></a></em></p>
...
Copy `release/Pact-v5.9.apk` to **both** phones — yours and each trusted person's — allow
